...
import lxy.liying.hdtvneu.adapter.QH_ProgramsAdapter;
 ...
 * =======================================================
 */
public class QHPListFragment extends LazyFragment implements On_QH_GetAllProgramsCallback, SwipeRefreshLayout.OnRefreshListener {
    /**
     * 数据
     */
    private QH_ProgramsAdapter programsAdapter;
    /**
     * 数据源
     */
    ...
    protected void onCreateViewLazy(Bundle savedInstanceState) {
        setContentView(R.layout.fragment_qh_plist);
        ...
        progressDialog.show();
        programsAdapter = new QH_ProgramsAdapter(getActivity());
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mainBinder.qh_getAllPrograms(QHPListFragment.this);
    ...
    public void onRefresh() {
        if (!isSearching) {
            btnSearch.setVisibility(View.GONE);
            mainBinder.qh_getAllPrograms(this);
